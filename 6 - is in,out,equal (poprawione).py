...
class algorytm:
    def is_in(self, interval1, interval2):
        return True if ((interval2 == (interval1 & interval2) or interval1 == (interval1 & interval2)) and interval1!=interval2) else False
    def is_equal(self, interval1, interval2):
        return True if interval1==interval2 else False
    def is_out(self, interval1, interval2):
        return False if (interval2 in (interval1 & interval2) or (interval1 in (interval1 & interval2))) else True
